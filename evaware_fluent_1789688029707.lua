...
local Window = Fluent:CreateWindow({
    Title = "Evaware Client",
    SubTitle = "Overhaul Version",
    TabWidth = 160,
...
local presetMaps = {
    { Title = "War map", Id = "106309926500291" },
}
...
MainTaTasTab:AddKeybind("playTAS", {
...
HitboxTaTasTab:AddKeybind("playTAS", {
...
FlyTaTasTab:AddKeybind("playTAS", {
    Title = "Fly Keybind",
    CurrentKeybind = "Nonе",
    HoldToInteract = false,
    Callback = function()
...
TasTaTasTab:AddKeybind("playTAS", {
    Title = "Start Recording",
    CurrentKeybind = "",
    HoldToInteract = false,
    Callback = StartRecord,
...
SaveManager:BuildConfigSection(Window:AddTab({ Title = "Config", Icon = "save" }))
