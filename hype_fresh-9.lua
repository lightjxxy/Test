local function safeLoad(url)
    ...
    warn("HyperionX: Failed to load " .. url)
    return nil
end

local Fluent         = safeLoad("https://raw.githubusercontent.com/StyearX/Script/refs/heads/main/Phantomwrym/Fluent-modded/Main.lua")
local SaveManager    = safeLoad("https://raw.githubusercontent.com/StyearX/Script/refs/heads/main/Phantomwrym/Fluent-modded/SaveManager.lua")
local FBM            = safeLoad("https://raw.githubusercontent.com/StyearX/Script/refs/heads/main/Phantomwrym/Fluent-modded/FloatingButtonManager.lua")
local InterfaceManager = safeLoad("https://raw.githubusercontent.com/StyearX/Script/refs/heads/main/Phantomwrym/Fluent-modded/InterfaceManager.lua")

-- Stub out FBM if it failed to load so the rest of the script doesn't error
if not FBM then
    FBM = {
...
-- Stub out SaveManager if it failed
...
-- Stub out InterfaceManager if it failed
...
if not Fluent then
    game.Players.LocalPlayer:Kick("HyperionX: Fluent UI failed to load. Check your internet connection.")
    return
end
